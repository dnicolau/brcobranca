    ...
    module Cnab400
      class BancoBrasil < Brcobranca::Remessa::Cnab400::Base
        ...
        def monta_detalhe(pagamento, sequencial)
          ...
          detalhe << pagamento.documento.to_s.ljust(25, ' ').format_size(25)  # controle do participante          X[25] 039 a 063
          ...
          detalhe << pagamento.identificacao_ocorrencia                       # comando (01 = registro de titulo) 9[02] 109 a 110
          ...
          detalhe << pagamento.dias_protesto.to_s.rjust(2, '0')               # numero de dias para protesto      X[02] 392 a 393
