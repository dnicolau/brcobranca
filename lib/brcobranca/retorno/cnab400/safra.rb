...
module Brcobranca
  module Retorno
    module Cnab400
      ...
      class Safra < Brcobranca::Retorno::Cnab400::Base
        ...
        fixed_width_layout do |parse|
          ...
          parse.field :nosso_numero, 62..70
          ...
          parse.field :motivo_ocorrencia, 104..106, ->(motivos) do
            motivos.scan(/.{3}/).reject(&:blank?).reject{|motivo| motivo == '000'}
          end
